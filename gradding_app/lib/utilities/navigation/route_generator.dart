...
import 'package:guest_dashboard/test_module/view/guest_dashboard_view.dart';
import 'package:ielts_dashboard/home_module/view/ielts_dashboard_view.dart';
...
final GoRouter goRouterConfig = GoRouter(
  ...
  routes: [
    ...
    ...guestRoutes(rootNavigatorKey: rootNavigatorKey, shellNavigatorKey: guestShellNavigatorKey),
    ...
    ShellRoute(
      ...
      routes: [
        GoRoute(
          ...
          path: IeltsGoPaths.ieltsDashboard,
          name: IeltsGoPaths.ieltsDashboard,
        ...
        GoRoute(
          parentNavigatorKey: shellNavigatorKey,
          path: GuestGoPaths.guestDashboard,
          name: GuestGoPaths.guestDashboard,
          builder: (context, state) {
            return const GuestDashboardView();
          },
        ),
        GoRoute(
          parentNavigatorKey: shellNavigatorKey,
